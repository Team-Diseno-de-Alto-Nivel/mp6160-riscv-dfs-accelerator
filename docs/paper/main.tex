...
The proposed architecture is a hardware accelerator built to run the Depth First Search (DFS) algorithm on 2D arrays. The system shifts the computational load from the main processor to a dedicated FPGA unit, 
