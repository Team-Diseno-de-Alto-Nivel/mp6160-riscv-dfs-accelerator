...
In this methodology the accelerator moves forward from a software reference implementation into a complete FPGA-based hardware system. Figure~\ref{fig:development_flow} illustrates the main stages of this process.
...
SystemC was chosen as the primary modeling language because it provides a suitable balance between a high-level description of the system and a close representation of hardware behavior. At the transaction level, it allows the behavior of the accelerator, its communication interfaces, and its internal hardware modules to be verified without the complexity of traditional RTL development.
